...
class PreferencesViewModel: ObservableObject {
    ...
    @Published var iconIndex: AnyHashable? = 0
    @Published var modeIndex: AnyHashable? = 0
    @AppStorage("enableNotifications") var enableNotifications = true
    @Published var notificationIndex :AnyHashable? = 0
            ...
            SettingPage(title: "配置") {
                        ...
                        if model.enableNotifications {
                            SettingGroup {
                                SettingPicker(
                                    ...
                                    data: [
                                        SettingPickerData("Every Hour",1),
                                        SettingPickerData("Every Day",2),
                                        SettingPickerData("Every Week",3)
                                    ],
                                    value: $model.notificationIndex
                                )
                ...
                SettingGroup {
                    SettingPicker(
                        title: "App Icon",
                        data: [
                            SettingPickerData("Classic",1),
                            SettingPickerData("Dark",2),
                            SettingPickerData("Neon",3)
                        ],
                        value: $model.iconIndex
                    )
                    
                    SettingPicker(
                        title: "Mode",
                        data: [
                            SettingPickerData("Automatic",1),
                            SettingPickerData("Light",2),
                            SettingPickerData("Dark",3)
                        ],
                        value: $model.modeIndex
                    )
                }
                
                SettingGroup {
                    SettingTextField(title: "Input", text: $model.text, placeholder: "Enter text here")
                }
